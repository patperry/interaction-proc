...
Section~\ref{S:enron-covariates}, as in our comparison to the actor-oriented model.  We used the \texttt{ergm} software package we used to fit the model, based on a Markov chain Monte Carlo sample size of $10^5$ following a burn-in period of $10^6$ iterates; an explanation of the covariates employed follows:
\begin{enumerate}
