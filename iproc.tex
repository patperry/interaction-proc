...
receiver covariates and considering their interactions (see
Fig.~\ref{T:group-static} for the resulting fit).  The bigger issue is
...
blatantly false: common sense tells us that if Junior $A$ sends a message
...
present for each main effect (Department, Seniority, and Gender).  Our final
