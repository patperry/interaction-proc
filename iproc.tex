...
tendency to shoehorn data into binary ties between entities.
...
shown in~\cite{dechoudhury2010}, thresholding pairwise interaction
...
The foundation of our work is Cox's proportional intensity model and
...
Lunag\'omez et al.~\cite{lunagomez2009geometric}'s recent work in the
...
social networks literature (see~\cite{snijders2010introduction} for a recent
...
$\tfrac{1}{n} \log \widetilde{\mathit{PL}}_{\tau_n}(\cdot)$ and
