...
\begin{figure}
  ...
  \caption{
    Estimated coefficients and standard errors for group-level covariates
    for the contingency table-based analysis of Section~\ref{sec:contin-analysis}
  }
...
comprised of the messages sent between January 1, 2001
and December 31, 2001.  We create three network
snapshots, $G_1$, $G_2$, and $G_3$, by dividing the year into $3$ consecutive
...
\begin{enumerate}
  ...
  measuring the out-degree of the sender.  The coefficient for this coefficient
