...
\[
    N_t(i,j)
        ...
        \}.
\]
For technical reasons, assume $N_0(i,j) = 0$ and $N_t(i,j)$ is
...
Brostr\"om adds a discrete component to $\Lambda$ while
Efron handles simultaneity through an ad-hoc adjustment
\cite{brostrom2002cox,efron1977efficiency}.)
...
some observable trait like ethnicity, gender, or age group.  The real
...
interactions  (assuming $\mathcal{I} = \mathcal{J}$), choose appropriate
...
$[\tfrac{k}{n}, \tfrac{k+1}{n})$, it takes the value $U_{\tau_k}$; i.e.,
...
$\tau_{\lfloor \alpha n \rfloor}$.  Therefore, since quadratic and
predictable variation have the same limit when it exists
\cite[Prop.~1]{rebolledo1980central}, assumption
...
condition necessary for the application of Rebolledo's Martingale Central
Limit Theorem~\cite{rebolledo1980central}.  Thus the process converges in
...
Inequality~\cite{lenglart1977relation}, that the second term converges
