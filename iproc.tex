...
\citefullauthor{papachristos2009murder}'s \citeyearpar{papachristos2009murder}
...
network data.  There are at least two treatments involving point processes,
neither of which includes reciprocation effects or other covariate
information: \citet{malmgen2009characterizing} models activity at the level of
the individual using a hidden Markov model; \citet{heard2010bayesian} works
...
applicable since they deal with ties persisting in time (e.g., friendship)
instead of instantaneous events.
Aside from Lunag\'omez et al.'s \citeyearpar{lunagomez2009geometric} recent
...
then \citep{andersen1993statistical, cook2007statistical, cox1975partial,
fleming1991counting, martinussen2006dynamic}.
