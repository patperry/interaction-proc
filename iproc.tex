...
$(t,i,j)$ triple.  Also, for convenience, assume
...
For the remaining complexity estimates we assume $w_0(\beta, i,j)$,
...
\section{Results from Section~\ref{S:MPLE-consistency}}
...
\section{Results from Section~\ref{S:multiple-receivers}}
