...
\begin{description}
    ...
    \item[Network effects] How are past interactions predictive the present?
    If we observe interactions $i \to h$ and $h \to j$, are we more likely
    to see the interaction $i \to j$?  What about other forms of transitivity?
    What are the important network effects and how do they manifest.
...
\cite{mcpherson2001birds}, \cite{butts2008relational},
\cite{aral2009distinguishing}, \cite{snijders2010introduction}, and the
references contained therein.  Multiplicity has largely been ignored in the
networks literature, with notable exceptions including work due to
\cite{lunagomez2009geometric} in the context of graphical models, and
\cite{shafiei2010mixed} for network modeling.  For a discussion of how our
work relates to this previous work, see Section.~\ref{S:discussion}.
...
person who I emailed at the time I received your original message (provided
