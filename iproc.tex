...
predictable increasing process $\Lambda_t(i,j)$ such that $N_t(i,j) - 
\Lambda_t(i,j)$ is an $\mathcal{F}_t$ local martingale.  Under mild conditions---the most important of which is that no two 
...
locally bounded vector of covariates in $\reals^p$.  Let $\beta_0$ in
