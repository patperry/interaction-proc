...
activity, where each $G_t$ is an $n \times n$ binary matrix
...
utility function that depends on characteristics of the overall network.
Essentially, given that the network is in state $G$, and that actor $i$ is allowed to make
