...
these employees (summarized in Table~\refTemployeesummary).
\begin{table}
...
memberships summarized in Table~\refTemployeesummary: abbreviating the
...
\begin{table}
    ...
    \caption{
        ...
        from equation~\eqref{E:log-pl-multiple-approx}.
...
the individual using a hidden Markov model; \citet{heard2010bayesian} work
