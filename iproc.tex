...
\cite{sundaresan2007network}'s study of zebras congregating at locations in
their habitat (an animal association network);
\cite{papachristos2009murder}'s study of gangs in Chicago murdering members
of rival factions (an organized crime network);
\cite{fowler2006connecting}'s study of legislators authoring and cosponsoring
bills (a collaboration network);
\cite{mckenzie2007network}'s study of families migrating between communities
in Mexico (a migration network).
