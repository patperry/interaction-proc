...
\begin{enumerate}[{A}1.]
    ...
    \[
        ...
        \Sigma_\alpha(\beta),
    \]
    where $\Sigma$ is locally bounded and Lipschitz in both arguments.
...
(assumption~A\ref{A:var-equicont}) and Lenglart's
Inequality~\cite{lenglart1977relation}.  As in the proof of
...
\(
    ...
    \right\|
\)
converges to zero uniformly in $\alpha$ and concludes the proof.
