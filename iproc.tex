...
\begin{figure}
    \centering
    \makebox{\includegraphics[scale=0.6]{figures/boot-resid-main}}
    \caption{
...
\begin{figure}[!t]
  ...
  \subfloat[
    ...
    \makebox{\includegraphics[scale=0.55]{figures/nobs-by-nexp-main}}}
  \\
  \subfloat[
    Pearson residual
    ...
    \makebox{\includegraphics[scale=0.55]{figures/resid-by-nexp-main}}}
...
Antihomophily is evidenced in that the sum of the coefficients for
...
Conspicuously, the only example of antihomophily is when the sender $i$ is in
...
$\exp(.63 - .91) \approx .76$ for the Legal department, $\exp(.28-.36) \approx
.92$ for the Trading department, and $\exp(0) = 1$ for any Other department.
...
\begin{figure}
  \centering
  \makebox{\includegraphics[scale=0.6]{figures/dyad-main}}
...
\begin{figure}
  \centering
  \makebox{\includegraphics[scale=0.6]{figures/triad-main}}
