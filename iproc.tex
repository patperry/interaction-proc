...
technical results from Sections~\ref{S:MPLE-consistency} and~\ref{S:multiple-receivers}.  Supplementary material provides comparative analyses based on related network models in the literature.
