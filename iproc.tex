...
\subsubsection{Dynamic covariates to measure behavior effects}
...
\begin{tabular}{p{2cm} c p{8cm}}
  ...
  \textbf{$2$-send} &
    ...
    \begin{picture}(9,1)
      ...
      \put(8.25,0){$j$}
    \end{picture} &
    there exists an actor $k$ such that $i$ has sent $k$ a message
    and $k$ has sent $j$ a message in the past
    \\
  \textbf{$2$-receive} &
    \vspace{-3em}
    \setlength{\unitlength}{1em}
    \begin{picture}(9,1)
      ...
      \put(8.25,0){$j$}
    \end{picture} &
    there exists an actor $k$ such that $i$ has received a message 
    from $k$, and $k$ has received a message from~$j$
    \\
  \textbf{sibling} &
    \setlength{\unitlength}{1em}
    \begin{picture}(5,5)(0,4)
      ...
      \put(3.75,0){$j$}
    \end{picture} &
    there exists an actor $k$ such that $k$ has sent $i$ and $j$
  ...
  \textbf{cosibling} &
    ...
    \begin{picture}(5,5)(0,4)
      ...
      \put(3.75,0){$j$}
    \end{picture} &
    there exists an actor $k$ such that $k$ has received messages
    from $i$ and~$j$
\end{tabular}

\noindent
To this end, we introduce binary indicators for all $6$ effects as components of $x_t(i,j)$.  These indicators depend on the sender $i$, the receiver, $j$, and the history of the process at the current time $t$.
