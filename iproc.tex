...
\begin{figure}[!t]
  \centering
  \makebox{\includegraphics[scale=0.6]{figures/multicast-error}}
  \caption{
...
\begin{figure}
    \centering
    \makebox{\includegraphics[scale=0.75]{figures/boot-resid-main}}
    \caption{
...
$1\{\textbf{2-send}\}$, whose estimated coefficients range from $0.65$ to $1.01$.
...
of Newton's method.  We refer the reader to \citet{tapia1971kantorovich} for a statement and elementary proof of the Kantorovich
Theorem.
