...
\title{%
    Point Process Modeling for Directed Interactions%
    \protect\thanksref{T1}
}

\runtitle{Point Process Modeling for Directed Interactions}
\thankstext{T1}{%
...
binary ties, a model is introduced for treating the interactions as a
...
% We prove consistency and asymptotic normality of our estimation 
% procedure as time increases, in
