...
ways in which network effects can manifest themselves in data.  These results are reinforced by a set of complementary analyses in Appendix~\ref{S:comparative}, where the corresponding
parameter estimates are compared to those obtained using related network models in the literature.
